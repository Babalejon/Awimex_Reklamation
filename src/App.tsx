    ...
    <header className="bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="/logo.svg" alt="Awimex logotyp" className="h-10 w-10" />
          <div>
            <div className="text-sm font-bold text-gray-900 tracking-wide leading-tight">AWIMEX</div>
            <div className="text-xs text-gray-500 font-medium leading-tight">International AB</div>
          </div>
        </div>
